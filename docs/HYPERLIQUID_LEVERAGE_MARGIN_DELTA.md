...
Hyperliquid leverage is now calculated using the **margin delta tracking** approach, identical to the Apex Omni implementation. This provides accurate per-position leverage for new positions.
