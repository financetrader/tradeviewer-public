    ...
    for o in (fills or []):
        try:
            ...
            data = {
                ...
                'entry_price': float(o.get('avgFillPrice') or o.get('price') or o.get('avgPrice') or 0) or 0.0,
                'exit_price': float(o.get('avgFillPrice') or o.get('price') or o.get('avgPrice') or 0) or 0.0,
